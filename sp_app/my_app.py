...
try:  # To capture all out of range dates
    ...
    while len(stock_name) != 0:
        ...
        ***
        ...
        if len(end_year) == 0:
            ...
            stl.write("""Showing """ + tickerSymbol, """Stock Price **From:** """ + start_year, """**To** Current 
            Date""")
            ...
            stl.write("""**NOTE:** You didn't **enter** Targeted Starting Date. **Starting Date is set to 2000-1-1 as 
            Default.**""")
            ...
            stl.write("""Showing """ + tickerSymbol, """Stock Price **From:** """ + start_from, """**To** Current 
            Date""")
            stl.write("""**NOTE:** You didn't **enter** Targeted Date for both Start and Close. **2000-1-1 and 
            Current Date are set as Default.**""")
        ...
        stl.write("""**NOTE:** Stock Name Not Provided. Please **Refresh the Browser** and **Enter Stock Name in 
        command Prompt.**\n""")

except OverflowError:
    # If the date you entered is out of range.
    stl.markdown("<h6 style='text-align: center; color: red '>NO DATA AVAILABLE FOR THE START DATE YOU PROVIDED</h6>", unsafe_allow_html=True)

stl.write("""Want to make new entries?
        \n**Refresh** your browser and get back to your command line to make new entries.""")

stl.write("""
    *** """)
# A little info about stocks
stl.markdown("<h6 style='text-align: center;'>A share price is the price of a single share of a number of saleable "
             "equity shares of a company. In layman's terms, the stock price is the highest amount someone is willing "
             "to pay for the stock, or the lowest amount that it can be bought for. The price is a reflection of the "
             "company’s value – what the public is willing to pay for a piece of the company. It can and will rise "
             "and fall, based on a variety of factors in the global landscape and within the company itself.</h6>",
